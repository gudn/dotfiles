...
calendar.create = function(screen)
   ...
   local clock_widget = wibox.widget.textclock("<span font='" .. beautiful.title_font .."'>%R (%a, %d %b)</span>", 1)
   ...
   local month_calendar = awful.widget.calendar_popup.month({
      ...
      long_weekdays = true,
      margin = 0, -- 10
      style_month = {border_width = 0, padding = 12, shape = cal_shape, padding = 10},
