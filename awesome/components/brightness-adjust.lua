...
local icon_dir = gears.filesystem.get_configuration_dir() .. "/icons/brightness/" .. beautiful.name .. "/"
   ...
   function()
      ...
      awful.spawn.easy_async_with_shell(
         ...
         function(stdout)
            ...
            if (brightness_level > 99) then
               brightness_icon:set_image(icon_dir .. "brightness-full.png")
            else
               brightness_icon:set_image(icon_dir .. "brightness.png")
            end
         end,
         false
      )
